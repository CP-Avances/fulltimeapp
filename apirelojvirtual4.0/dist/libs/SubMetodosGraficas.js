...
const BuscarTimbresByFecha = function (fec_inicio, fec_final) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield database_1.pool.query('SELECT fecha_hora_timbre FROM eu_timbres WHERE CAST(fecha_hora_timbre AS VARCHAR) between $1 || \'%\' AND $2 || \'%\' ORDER BY fecha_hora_timbre ASC', [fec_inicio, fec_final])
            .then(res => {
            return res.rows;
        });
    });
...
const BuscarTimbresByCodigo_Fecha = function (codigo, horario) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield Promise.all(horario.map((obj) => __awaiter(this, void 0, void 0, function* () {
            return {
                fecha: obj.fecha,
                timbresTotal: yield database_1.pool.query('SELECT fecha_hora_timbre FROM eu_timbres WHERE CAST(fecha_hora_timbre AS VARCHAR) like $1 || \'%\' AND codigo = $2 ORDER BY fecha_hora_timbre ASC', [obj.fecha, codigo])
                    .then(res => {
                    return res.rowCount;
                })
            };
    ...
    return __awaiter(this, void 0, void 0, function* () {
        return yield database_1.pool.query('SELECT CAST(h.fecha_inicio AS VARCHAR), CAST(h.fecha_final AS VARCHAR), h.descripcion, h.horas_solicitud, h.tiempo_autorizado, h.id_empleado_solicita, h.id_empleado_cargo ' +
            ...
            return Promise.all(result.rows.map((obj) => __awaiter(this, void 0, void 0, function* () {
                const hora_inicio = (0, exports.HHMMtoSegundos)(obj.fecha_inicio.split(' ')[1]) / 3600;
                const hora_final = (0, exports.HHMMtoSegundos)(obj.fecha_final.split(' ')[1]) / 3600;
                return {
...
const BuscarTimbresEntradas = function (fec_inicio, fec_final) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield database_1.pool.query('SELECT CAST(fecha_hora_timbre AS VARCHAR), codigo FROM eu_timbres WHERE CAST(fecha_hora_timbre AS VARCHAR) between $1 || \'%\' AND $2 || \'%\' AND accion in (\'EoS\', \'E\') ORDER BY fecha_hora_timbre ASC ', [fec_inicio, fec_final])
            .then(res => {
            return res.rows;
        });
    });
...
const Empleado_Vacaciones_ModelarDatos = function (codigo, fec_desde, fec_hasta) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        vacaciones.forEach(obj => {
            ...
            var fecha1 = (0, moment_1.default)(obj.fecha_inicio.split(" ")[0]);
            var fecha2 = (0, moment_1.default)(obj.fecha_final.split(" ")[0]);
            var diasHorario = fecha2.diff(fecha1, 'days') + 1;
            for (let i = 0; i < diasHorario; i++) {
                let horario_res = {
                    fecha: fec_aux.toJSON().split('T')[0],
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        permisos.forEach(obj => {
            ...
            for (let i = 0; i < diasHorario; i++) {
                let horario_res = {
                    fecha: fec_aux.toJSON().split('T')[0],
                    tiempo: (obj.dias_permiso + ((0, exports.HHMMtoSegundos)(obj.horas_permiso) / 3600)) / diasHorario,
                };
                aux_array.push(horario_res);
                fec_aux.setDate(fec_aux.getDate() + 1);
            }
