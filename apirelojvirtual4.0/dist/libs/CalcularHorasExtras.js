...
const CalcularHoraExtra = function (id_empleado, codigo, fec_desde, fec_hasta) {
...
function FeriadosPorIdCargo(id_cargo, fec_desde, fec_hasta) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield database_1.pool.query('SELECT f.fecha, f.fecha_recuperacion, f.descripcion FROM eu_empleado_cargos AS ec, e_sucursales AS s, e_ciudades AS c, ' +
            'ef_ciudad_feriado AS cf, ef_cat_feriados AS f WHERE ec.id = $1 AND ec.id_sucursal = s.id AND s.id_ciudad = c.id AND ' +
...
function HorasExtrasSolicitadas(codigo, id_cargo, fec_desde, fec_hasta) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield database_1.pool.query('SELECT h.fecha_inicio, h.fecha_final, h.descripcion, h.horas_solicitud, h.tiempo_autorizado ' +
            'FROM mhe_solicitud_hora_extra AS h WHERE h.id_empleado_cargo = $1 AND h.fecha_inicio between $2 and $3 ' +
            'AND h.fecha_final between $2 and $3 ORDER BY h.fecha_inicio', [id_cargo, fec_desde, fec_hasta])
            .then(result => {
            return Promise.all(result.rows.map((obj) => __awaiter(this, void 0, void 0, function* () {
                ...
                const hora_inicio = (0, metodos_1.HHMMtoSegundos)(f1.toJSON().split('T')[1].split('.')[0]);
                const hora_final = (0, metodos_1.HHMMtoSegundos)(f2.toJSON().split('T')[1].split('.')[0]);
                ...
                return {
                    ...
                    descripcion: obj.descripcion,
                    num_hora: (0, metodos_1.HHMMtoSegundos)(obj.num_hora),
                    tiempo_autorizado: (0, metodos_1.HHMMtoSegundos)(obj.tiempo_autorizado),
...
function PlanificacionHorasExtrasSolicitadas(codigo, id_cargo, fec_desde, fec_hasta) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield database_1.pool.query('SELECT h.fecha_desde, h.hora_inicio, h.fecha_hasta, h.hora_fin, h.descripcion, h.horas_totales, ph.tiempo_autorizado ' +
            'FROM mhe_empleado_plan_hora_extra AS ph, mhe_detalle_plan_hora_extra AS h WHERE ph.id_empleado_cargo = $1 AND ph.id_detalle_plan = h.id ' +
            ...
            return Promise.all(result.rows.map((obj) => __awaiter(this, void 0, void 0, function* () {
                ...
                return {
                    ...
                    fec_final: new Date(f2.toJSON().split('.')[0]),
                    descripcion: obj.descripcion,
                    num_hora: (0, metodos_1.HHMMtoSegundos)(obj.horas_totales),
...
function ObtenerTimbres(codigo, fec_desde, fec_hasta) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield database_1.pool.query('SELECT fecha_hora_timbre, accion FROM eu_timbres WHERE codigo = $1 AND accion  in (\'EoS\', \'E\', \'S\') AND fecha_hora_timbre BETWEEN $2 AND $3 ORDER BY fecha_hora_timbre', [codigo, fec_desde, fec_hasta])
            .then(result => {
...
function CargoContratoByFecha(id_empleado, fec_desde, fec_hasta) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const cargo_contrato = yield database_1.pool.query('SELECT (e.nombre || \' \' || e.apellido) as nombre, e.codigo, e.cedula, ca.id AS id_cargo, ca.fecha_inicio, ca.fecha_final, co.id AS id_contrato, ca.sueldo, ca.hora_trabaja FROM eu_empleados AS e, eu_empleado_contratos AS co, eu_empleado_cargos AS ca ' +
                'WHERE e.id = co.id_empleado AND co.id_empleado = $1 AND ca.id_contrato = co.id OR ca.fecha_inicio BETWEEN $2 AND $3 OR ca.fecha_final BETWEEN $2 AND $3 ', [id_empleado, fec_desde, fec_hasta])
                .then(result => {
                return result.rows;
            });
...
function CatalogoHorasExtras() {
    return __awaiter(this, void 0, void 0, function* () {
        return yield database_1.pool.query('SELECT id, descripcion, tipo_descuento, recargo_porcentaje, hora_inicio, hora_final, hora_jornada, tipo_dia, tipo_funcion FROM mhe_configurar_hora_extra').then(result => {
            return result.rows.map(obj => {
                obj.hora_inicio = (0, metodos_1.HHMMtoSegundos)(obj.hora_inicio);
                obj.hora_final = (0, metodos_1.HHMMtoSegundos)(obj.hora_final);
                (obj.tipo_descuento === 1) ? obj.tipo_descuento = 'HE' : obj.tipo_descuento = 'RN';
                obj.recargo_porcentaje = parseInt(obj.recargo_porcentaje) / 100;
