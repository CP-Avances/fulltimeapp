...
const getUbicacion = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield database_1.pool.query('SELECT longitud, latitud FROM eu_empleados WHERE codigo = $1', [codigo]);
...
const getHorariosEmpleadoByCodigo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getHorariosEmpleadoByCodigo = getHorariosEmpleadoByCodigo;
const BuscarPlanificacionHorarioEmple = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { fecha_inicio, fecha_final, codigo } = req.query;
        const HORARIO = yield database_1.pool.query("SELECT codigo_e, nombre_e, anio, mes, " +
...
exports.BuscarPlanificacionHorarioEmple = BuscarPlanificacionHorarioEmple;
const getPlanificacionMesesCodigoEmple = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { codigo } = req.query;
        const HORARIO = yield database_1.pool.query("SELECT codigo_e, nombre_e, anio, mes, " +
            "CASE WHEN STRING_AGG(CASE WHEN dia = 1 THEN codigo_dia end,', ') IS NOT NULL THEN STRING_AGG(CASE WHEN dia = 1 THEN codigo_dia end,', ') ELSE '-' END AS dia1, " +
