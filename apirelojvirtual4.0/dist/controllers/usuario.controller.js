...
exports.ObtenerDepartamentoUsuarios = exports.getidDispositivo = exports.ingresarIDdispositivo = exports.getEmpleadosActivos = exports.loginUsuario = exports.getUserById = exports.getUsers = void 0;
...
const getUsers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield database_1.pool.query('SELECT * FROM eu_usuarios ORDER BY usuario ASC');
...
const getUserById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield database_1.pool.query("SELECT * FROM eu_usuarios WHERE id = $1", [id]);
        const usuarios = response.rows;
...
const loginUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const [data_empresa] = yield database_1.pool.query('SELECT e.id as id_contrato, c.hora_trabaja, ' +
            ...
            'cg_e.public_key, (SELECT id FROM mv_periodo_vacacion pv WHERE pv.id_empleado = empl.id ' +
            ...
            's.id_empresa = cg_e.id ORDER BY c.fecha_inicio DESC LIMIT 1', [id_registro_empleado])
        ...
        try {
            if (yield compararContraseña(contrasena, usuarios[0].contrasena)) {
                if (usuarios[0].app_habilita) {
                    ...
                    const [config_noti] = yield database_1.pool.query('SELECT * FROM eu_configurar_alertas WHERE id_empleado = $1', [id_registro_empleado]).then(result => { return result.rows; });
                    // CONSULTA DE VACUNA
...
const ObtenerDepartamentoUsuarios = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const EMPLEADO = yield database_1.pool.query(`
            SELECT e.id, e.id_departamento, e.id_contrato, ed_departamentos.nombre FROM datos_actuales_empleado AS e 
