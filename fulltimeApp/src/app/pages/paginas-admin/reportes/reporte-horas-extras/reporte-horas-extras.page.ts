...
import { ReporteHoraExtraComponent } from '../../../../modals/reporte-hora-extra/reporte-hora-extra.component';
import moment, { min } from 'moment';
moment.locale('es');

@Component({
  selector: 'app-reporte-horas-extras',
  templateUrl: './reporte-horas-extras.page.html',
  styleUrls: ['./reporte-horas-extras.page.scss'],
})
export class ReporteHorasExtrasPage {
  ...
  async presentModal(objeto: any) {
    ...
    const modal = await this.modalController.create({
      component: ReporteHoraExtraComponent,
      componentProps: {
        'data': objeto,
      },
  ...
  ionViewWillLeave(){
    console.log('Salo de reporte de Horas Extras');
