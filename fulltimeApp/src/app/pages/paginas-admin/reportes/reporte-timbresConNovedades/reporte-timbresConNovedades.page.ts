...
import { ReporteTimbreConNovedadesComponent } from '../../../../modals/reporte-timbreConNovedades/reporte-timbreConNovedades.component';
...
@Component({
  selector: 'app-reporte-timbresConNovedades',
  templateUrl: './reporte-timbresConNovedades.page.html',
...
export class ReporteTimbresConNovedadesPage {
  ...
  //METODO PARA ABRIR EL MODAL DEL REPORTE DE TIMBRES CON NOVEDADES
  ...
  ionViewWillLeave() {
    console.log('Salo de reporte de Timbres con Novedad');
