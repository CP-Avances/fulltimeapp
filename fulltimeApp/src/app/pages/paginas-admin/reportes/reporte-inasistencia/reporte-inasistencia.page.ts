...
import { ReporteInasistenciaComponent } from '../../../../modals/reporte-inasistencia/reporte-inasistencia.component';
...
@Component({
  ...
  templateUrl: './reporte-inasistencia.page.html',
  styleUrls: ['./reporte-inasistencia.page.scss'],
})
export class ReporteInasistenciaPage {
  ...
  async presentModal(objeto: any) {
    ...
    const modal = await this.modalController.create({
      component: ReporteInasistenciaComponent,
      componentProps: {
        'data': objeto,
      },
