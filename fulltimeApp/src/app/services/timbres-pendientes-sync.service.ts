    ...
    return {
      ...
      */
      ...
      /*
        ...
        del servidor únicamente cuando detecta sincronizado / desde_memoria.
      */
      fecha_subida_servidor: null,

      /*
        Se mantiene false porque el timbre originalmente no llegó al servidor
        al momento de ser generado.
      */
      conexion: false,
